# Generated by Django 2.2.14 on 2023-03-23 01:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge', models.CharField(blank=True, choices=[('New', 'New')], max_length=5, null=True)),
                ('discount_price', models.FloatField(blank=True, null=True)),
                ('category', models.CharField(choices=[('C', 'camera'), ('TP', 'tripods'), ('FL', 'flashlights'), ('MC', 'memoryCards'), ('CB', 'cameraBags'), ('B', 'batteries')], max_length=2)),
                ('brand', models.CharField(choices=[('C', 'Canon'), ('S', 'Sony'), ('N', 'Nikon'), ('F', 'Fujifilm'), ('P', 'Panasonic'), ('O', 'Olympus'), ('PX', 'Pentax'), ('IN', 'Instax')], max_length=3)),
                ...
                ('stripe_key', models.CharField(default='default key', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_date', models.CharField(blank=True, default=None, max_length=10, null=True)),
